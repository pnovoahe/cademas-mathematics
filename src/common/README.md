...
experiments in the companion paper *Aggregation Semantics for Prioritization
in Cooperative Automated Decision Making*.

Individual experiments live in numbered folders under `src/` and
...
- Kendall $\tau$ on the Top-$K$ union / Jaccard Top-$K$ for ranking stability
