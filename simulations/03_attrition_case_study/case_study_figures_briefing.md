...
Purpose: give an LLM enough context to draft / revise the LaTeX subsection
**Results and Interpretation** in `first_round_v3/manuscriptR1V3.tex`
(Section *Employee Attrition Case Study*), using only what the figures show
and the quantitative results behind them.
...
Source experiment: `simulations/03_attrition_case_study/`.
Manuscript figures live in `first_round_v3/figures/`.
...
```text
simulations/03_attrition_case_study/figures/attrition_case_overview.{pdf,png}
simulations/03_attrition_case_study/figures/attrition_rank_bump_delta.{pdf,png}
simulations/03_attrition_case_study/figures/attrition_rank_bump.{pdf,png}   # not in MS
first_round_v3/figures/  (copies used by manuscriptR1V3.tex)
